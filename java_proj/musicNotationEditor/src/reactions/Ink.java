...
public class Ink implements I.Show {
    ...
    public static class Buffer extends G.PL implements I.Show, I.Area {
        ...
        public int n; // points in buffer, counter
        ...
        public void show(Graphics g) {drawNDots(g, n);} // bBox.draw(g);} // comment out the bBox on g
        ...
        public void subSample(G.PL pl) {
            int K = pl.size(); // return # of points in the PolyLine
            for (int i = 0; i < K; i++) {
                int j = i * (n - 1) / (K - 1); // transforming or scaling by multiplying ((n-1)/(K-1))
