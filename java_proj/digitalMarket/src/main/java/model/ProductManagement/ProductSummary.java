...
public class ProductSummary {
    ...
    public void printOneProductSummary(){
        System.out.println("-------------------------------------------------------------------------");
        System.out.println("Product of Summary from " +subjectproduct.getProductID() + " " + subjectproduct.getName() );
        System.out.println("*Sales Revenue:$" + getSalesRevenues());
        System.out.println("*Sales Volume:" + getSubjectProduct().getNumberOfSoldProducts());
